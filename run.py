...
def main():
    ...
    if 'gpt' in args.experiment_name_or_path:
        instantiation_schemes_new = {
        "nor_qa": {},
        "oner": {"bm25_retrieval_count": ["6"]}, # gpt: ['6'] flan: ["15"]
        "oner_qa": {
            "bm25_retrieval_count": ["6"],
    ...
    elif 'flan' in args.experiment_name_or_path:
        instantiation_schemes_new = {
        "nor_qa": {},
    ...
    instantiation_scheme = instantiation_schemes_new[args.instantiation_scheme]
