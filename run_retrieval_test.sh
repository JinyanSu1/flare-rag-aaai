...
python runner.py $1 $2 $3 predict --prompt_set 1 --eval_test --official --llm_port_num $4 --sample_size 500

echo ">>>> Run evaluation for the best HP on the test set <<<<"
python runner.py $1 $2 $3 evaluate --prompt_set 1 --eval_test --official --llm_port_num $4 --sample_size 500